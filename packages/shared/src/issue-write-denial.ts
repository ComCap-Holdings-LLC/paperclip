  ...
  switch (code) {
    ...
    case "cross_issue_influence_cap_exceeded": {
      ...
      return {
        ...
        boundary: `Cross-issue cap of ${cap} writes per rolling minute and 200 writes per run`,
        ...
        description:
          ...
          `updates combined in the previous 60 seconds according to the server's database clock, with a 200-write lifetime ceiling per run${attempt !== null ? `; this was attempt ${attempt}` : ""}. The cap ` +
